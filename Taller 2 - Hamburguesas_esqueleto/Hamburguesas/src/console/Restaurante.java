...
public class Restaurante {
	...
	public ArrayList<ProductoMenu> getMenuBase() {
		...
		ArrayList<ProductoMenu> arrayMenuBase = cargarMenu("/Users/luchopinilla/Downloads/ANDES/TERCER/DPOO/Taller 2 - Hamburguesas_esqueleto/data/menu.txt");
	...
	public ArrayList<Ingrediente> getIngredientes(){
		...
		ArrayList<Ingrediente> arrayIngredientes = cargarIngredientes("/Users/luchopinilla/Downloads/ANDES/TERCER/DPOO/Taller 2 - Hamburguesas_esqueleto/data/ingredientes.txt");
	...
	public ArrayList<Combo> getCombo(){
		...
		ArrayList<Combo> arrayCombo = cargarCombos("/Users/luchopinilla/Downloads/ANDES/TERCER/DPOO/Taller 2 - Hamburguesas_esqueleto/data/combos.txt");
	...
	private static ArrayList<Ingrediente> cargarIngredientes(String archivoIngredientes) {
		...
		try(BufferedReader reader = new BufferedReader(new FileReader(archivoIngredientes))){
				...
				}catch(IOException e) {System.err.println("IOException Error");};
				return ingredientes;
	...
	//LO HICE PUBLIC TEMPORALMENTE CAMBIAR A PRIVATE
